                ...
                if (typeof binding.value === 'function') {
                    ...
                    switch (binding.arg) {
                        ...
                        case 'swiperight':
                            ...
                            break;
                        case 'swipeup':
                            if (res.dir === 'up' && Math.abs(res.y1 - res.y2) > 30) {
                                _handler();
                            }
                            break;
                        case 'swipedown':
                            if (res.dir === 'down' && Math.abs(res.y1 - res.y2) > 30) {
                                _handler();
                            }
                            break;
                    }
...
var domEventHelper = __webpack_require__(47);
...
//# sourceMappingURL=vendor.7851514a6e6ebbbbd972.js.map